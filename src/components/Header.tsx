...
export default function Header(){
    ...
    return(
        <section className="bg-[#0F0F0F] h-full px-10 max-md:px-4 py-7.5 max-md:py-3 relative">
            <div className="bg-[#191919] px-7 max-md:px-5.5 py-4 max-md:py-6.5 rounded-xl flex flex-row items-center justify-between">
                <svg
                ...
                <button
                    ...
                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M13 16.75C13 16.3358 13.3358 16 13.75 16H30.25C30.6642 16 31 16.3358 31 16.75C31 17.1642 30.6642 17.5 30.25 17.5H13.75C13.3358 17.5 13 17.1642 13 16.75ZM13 22C13 21.5858 13.3358 21.25 13.75 21.25H30.25C30.6642 21.25 31 21.5858 31 22C31 22.4142 30.6642 22.75 30.25 22.75H13.75C13.3358 22.75 13 22.4142 13 22ZM21.25 27.25C21.25 26.8358 21.5858 26.5 22 26.5H30.25C30.6642 26.5 31 26.8358 31 27.25C31 27.6642 30.6642 28 30.25 28H22C21.5858 28 21.25 27.6642 21.25 27.25Z" fill="white"/>
                    </svg>
